...
func Test_OrderStatusToString(t *testing.T) {
	...
	assert.Equal(t, "PAYMENT_REVERSED_ERROR", OrderStatusPaymentReversedError.ToString())
...
func Test_ToOrderStatus(t *testing.T) {
	...
	assert.Equal(t, OrderStatusPaymentReversedError, ToOrderStatus("PAYMENT_REVERSED_ERROR"))
